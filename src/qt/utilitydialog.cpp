    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Etp Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Etp Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  etp-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Etp in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ETP, 0.1 ETP, 1 ETP and 10 ETP -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://etppay.atlassian.net/wiki/display/DOC/PrivateSend\">https://etppay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Etp Core is shutting down...") + "<br /><br />" +
