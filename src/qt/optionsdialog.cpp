    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ETP-light"), QVariant("light"));
    ui->theme->addItem(QString("ETP-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ETP-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ETP-traditional"), QVariant("trad"));
