    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Etp Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Etp address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and etp: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Etp Core"), this);
    aboutAction->setStatusTip(tr("Show information about Etp Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Etp Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Etp addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Etp addresses"));
    ...
    openAction->setStatusTip(tr("Open a etp: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Etp Core help message to get a list with possible Etp Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Etp Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Etp network", "", count));
}
...
{
    QString strTitle = tr("Etp Core"); // default title
