 ...
 *
 *   // network
 *   CEtpNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.etp.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEtpNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EtpNetwork
// //   -- signature requirements : Key1(User)
// class CEtpNetworkVariable : public CGovernanceObject
// {
// private:
