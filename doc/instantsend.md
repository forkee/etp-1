...
This mechanism has been integrated into Bitcore-Node-Etp which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/etppay/insight-api-etp#web-socket-api](https://github.com/etppay/insight-api-etp#web-socket-api) 
* API: [https://github.com/etppay/insight-api-etp#instantsend-transactions](https://github.com/etppay/insight-api-etp#instantsend-transactions) 
...
By default, the Etp Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Etp Core daemon:
