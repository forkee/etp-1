...
Etp Core version 0.01.0 is now available from:

  https://etptoken.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/fxbitlab/etp/issues
...
backwards-compatible with pre-0.12 versions of Etp Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/etp/).
