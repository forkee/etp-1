...
Only requiring some minor changes is etp.cpp.
...
Changes to etp.cpp
----------------------
etp.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
